...
const Footer = () => {
  ...
  const [isOpen, setIsOpen] = useState(false); // Define state for modal open/close
  ...
  const toggleModal = () => {
    setIsOpen(!isOpen); // Toggle modal state
  };
        ...
        <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
          <div className="flex items-center justify-between flex-wrap gap-5">
            ...
            <button 
              ...
              onClick={openWebsite} // Call the openWebsite function when the button is clicked
            >
              <img
                src="/phone-call.png"
                alt="headset"
